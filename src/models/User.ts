...
class User {
    ...
    public setData(properties: IUser) {
        ...
        properties.password     ? this.password       = properties.password.trim() : undefined
        properties.email        ? this.email          = properties.email.trim()    : undefined
        properties.firstName    ? this.firstName      = properties.firstName.trim(): undefined
        properties.lastName     ? this.lastName       = properties.lastName.trim() : undefined
    }
