...
test('convert valid phones in chatIds', ()=>{
    ...
    expect(PhoneValidators.formattedPhoneToChatId(PhoneValidators.formatPhone(validPhoneStr))).toBe('558784762135@c.us')
    expect(PhoneValidators.formattedPhoneToChatId(PhoneValidators.formatPhone(otherValidPhoneStr))).toBe('5545389453@c.us')
})